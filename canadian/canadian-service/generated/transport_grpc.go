...
// MakeGRPCServer makes a set of endpoints available as a gRPC CanadianServer.
func MakeGRPCServer(ctx context.Context, endpoints Endpoints) pb.CanadianServer {
...
// grpcServer implements the CanadianServer interface
type grpcServer struct {
	translate grpctransport.Handler
}

// Methods for grpcServer to implement CanadianServer interface
