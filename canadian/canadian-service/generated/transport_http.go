...
func MakeHTTPHandler(ctx context.Context, endpoints Endpoints, logger log.Logger) http.Handler {
	...
	m.Handle("/canadian", httptransport.NewServer(
		ctx,
		endpoints.TranslateEndpoint,
		HttpDecodeLogger(DecodeHTTPTranslateZeroRequest, logger),
...
// DecodeHTTPTranslateZeroRequest is a transport/http.DecodeRequestFunc that
// decodes a JSON-encoded translate request from the HTTP request
// body. Primarily useful in a server.
func DecodeHTTPTranslateZeroRequest(_ context.Context, r *http.Request) (interface{}, error) {
	...
	pathParams, err := PathParams(r.URL.Path, "/canadian")
	_ = pathParams
	if err != nil {
...
// DecodeHTTPTranslate is a transport/http.DecodeResponseFunc that decodes
// a JSON-encoded TranslateResponse response from the HTTP response body.
// If the response has a non-200 status code, we will interpret that as an
// error and attempt to decode the specific error message from the response
// body. Primarily useful in a client.
func DecodeHTTPTranslateResponse(_ context.Context, r *http.Response) (interface{}, error) {
...
// EncodeHTTPTranslateZeroRequest is a transport/http.EncodeRequestFunc
// that encodes a translate request into the various portions of
// the http request (path, query, and body).
func EncodeHTTPTranslateZeroRequest(_ context.Context, r *http.Request, request interface{}) error {
