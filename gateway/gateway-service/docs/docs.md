...
| ---- | ---- | ------------ | -----------|
| Phrase | TYPE_STRING | 1 |  |
| Languages | TYPE_STRING | 2 |  |

<a name="TranslateResponse"></a>
...
| ---- | ---- | ------------ | -----------|
| Translate | TranslateRequest | TranslateResponse | Echo "echos" the incoming string |
...
| ---- | ---- | ------------ |
| Phrase | body | TYPE_STRING |
| Languages | body | TYPE_STRING |
