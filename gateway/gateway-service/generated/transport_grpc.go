...
// MakeGRPCServer makes a set of endpoints available as a gRPC GatewayServer.
func MakeGRPCServer(ctx context.Context, endpoints Endpoints) pb.GatewayServer {
...
// grpcServer implements the GatewayServer interface
type grpcServer struct {
	translate grpctransport.Handler
}

// Methods for grpcServer to implement GatewayServer interface
